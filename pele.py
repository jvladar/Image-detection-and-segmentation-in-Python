...
from sm import multi_unet_model #Uses softmax 
...
for directory_path in glob.glob("128_patches/images.tif"):
...
train_masks = [] 
for directory_path in glob.glob("128_patches/masks.tif"):
...
#         single_patch_norm = np.expand_dims(normalize_data_format(np.array(single_patch), axis=1),2)
